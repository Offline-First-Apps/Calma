...
export const themedColors: readonly ThemedVar[] = [
  ...
  /** Settings (j1-j4), the states (k1-k6), and the tab shelf. */
  { cssVar: 'row-separator', lightValue: light.rowSeparator, darkValue: dark.rowSeparator },
  { cssVar: 'toggle-track-off', lightValue: light.toggleTrackOff, darkValue: dark.toggleTrackOff },
  { cssVar: 'toggle-knob', lightValue: light.toggleKnob, darkValue: dark.toggleKnob },
  { cssVar: 'toggle-knob-off', lightValue: light.toggleKnobOff, darkValue: dark.toggleKnobOff },
  { cssVar: 'chevron', lightValue: light.chevron, darkValue: dark.chevron },
  { cssVar: 'sheet-border', lightValue: light.sheetBorder, darkValue: dark.sheetBorder },
  { cssVar: 'sheet-grabber', lightValue: light.sheetGrabber, darkValue: dark.sheetGrabber },
  { cssVar: 'backdrop-sheet', lightValue: light.backdropSheet, darkValue: dark.backdropSheet },
  { cssVar: 'destructive', lightValue: light.destructive, darkValue: dark.destructive },
  { cssVar: 'surface-destructive', lightValue: light.surfaceDestructive, darkValue: dark.surfaceDestructive },
  { cssVar: 'border-destructive', lightValue: light.borderDestructive, darkValue: dark.borderDestructive },
  { cssVar: 'surface-empty-page', lightValue: light.surfaceEmptyPage, darkValue: dark.surfaceEmptyPage },
  { cssVar: 'border-empty-page', lightValue: light.borderEmptyPage, darkValue: dark.borderEmptyPage },
  { cssVar: 'empty-page-rule', lightValue: light.emptyPageRule, darkValue: dark.emptyPageRule },
  { cssVar: 'immersive-foreground', lightValue: light.textImmersive, darkValue: dark.textImmersive },
  { cssVar: 'immersive-secondary', lightValue: light.textImmersiveSecondary, darkValue: dark.textImmersiveSecondary },
  { cssVar: 'lock-shackle', lightValue: light.lockShackle, darkValue: dark.lockShackle },
  { cssVar: 'shelf', lightValue: light.shelf, darkValue: dark.shelf },
  { cssVar: 'shelf-border', lightValue: light.shelfBorder, darkValue: dark.shelfBorder },
  { cssVar: 'shelf-worry', lightValue: light.shelfWorry, darkValue: dark.shelfWorry },
  { cssVar: 'shelf-worry-border', lightValue: light.shelfWorryBorder, darkValue: dark.shelfWorryBorder },
  { cssVar: 'shelf-write', lightValue: light.shelfWrite, darkValue: dark.shelfWrite },
  { cssVar: 'shelf-write-border', lightValue: light.shelfWriteBorder, darkValue: dark.shelfWriteBorder },
  { cssVar: 'shelf-highlight', lightValue: light.shelfHighlight, darkValue: dark.shelfHighlight },
  { cssVar: 'aside-warm', lightValue: light.asideWarm, darkValue: dark.asideWarm },
